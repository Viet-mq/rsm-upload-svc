...
@Service
public class SendRejectEmailToPresenterService implements SendEmailService {
    ...
    public SendRejectEmailToPresenterService(EmailSender emailSender, MongoDbOnlineSyncActions db) {
