...
@Service
public class SendCalendarEmailToPresenterService implements SendEmailService {
    ...
    public SendCalendarEmailToPresenterService(EmailSender emailSender, MongoDbOnlineSyncActions db) {
